...
(
	...
	CONSTRAINT uc_PHONE UNIQUE (MAC_Address, Token)
);
...
(
	...
	Action_Name VARCHAR(10) NOT NULL DEFAULT 'Door Unlocked',
	Time_Marked VARCHAR(255) NOT NULL,
	...
	CHECK (Action_Name in ('Door Unlocked') ),
