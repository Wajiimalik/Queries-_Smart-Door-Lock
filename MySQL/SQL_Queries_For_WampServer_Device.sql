...
(
	...
	Status VARCHAR(7) NOT NULL DEFAULT 'Close' CHECK ( Status in('Close', 'Open')),
...
(
	...
	Privilege TINYINT(1) NOT NULL DEFAULT 1 CHECK (Privilege>0 AND Privilege<3),
...
(
	...
	Name VARCHAR(20) NOT NULL CHECK (Name in ('Camera', 'Bell Ring', 'Door Knock', 'Lock Tamper', 'Human Detector')),
...
(
	...
	Action_Name VARCHAR(10) NOT NULL CHECK (Action_Name in ('Unlock', 'Lock','Ignore') ),
...
(
	...
	Activity_Name VARCHAR(20) NOT NULL CHECK (Activity_Name in ('Door Bell Ringed', 'Door Knock', 'Door Tampered', 'Human Detected')),
